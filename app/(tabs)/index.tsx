...
const styles = StyleSheet.create({
  ...
  liveText: { fontSize: 11, fontWeight: "900", color: COLORS.accent, letterSpacing: 1 },
  mainCard: { backgroundColor: COLORS.primary, borderRadius: 30, padding: 26, shadowColor: COLORS.primary, shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.22, shadowRadius: 18, elevation: 8 },
  mainSubject: { fontSize: 22, fontWeight: "800", color: COLORS.white, marginBottom: 4 },
  mainProfessor: { fontSize: 15, color: "rgba(255,255,255,0.6)", marginBottom: 25 },
  progressArea: { marginBottom: 25 },
  progressTextRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 8 },
  progressLabel: { fontSize: 11, color: "rgba(255,255,255,0.4)", fontWeight: "700" },
  ...
  mainFooter: { flexDirection: "row", gap: 20, borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.08)", paddingTop: 18 },
  ...
  countBadge: { backgroundColor: COLORS.tagBg, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  ...
  pastCard: { flexDirection: "row", alignItems: "center", padding: 18, backgroundColor: "rgba(226, 232, 240, 0.3)", borderRadius: 20, gap: 15, borderWidth: 1, borderColor: COLORS.border, borderStyle: "dashed" },
  pastInfo: { flex: 1 },
